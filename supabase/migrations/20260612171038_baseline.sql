-- ============================================================================
--  BASELINE migration — mirrors the hand-run supabase-schema.sql as it stood
--  when migrations were introduced. Idempotent (create if not exists / drop
--  policy if exists), so pushing it to a project whose tables already exist is
--  a safe no-op. Every schema change AFTER this goes in a NEW migration file
--  (npx supabase migration new <name>) — never edit this baseline.
-- ============================================================================
...
-- ============================================================================
--  Seed the wiki pool for the automatic daily picker.
-- ============================================================================
